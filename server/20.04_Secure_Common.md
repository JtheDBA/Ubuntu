...
Note: I am now using Thomas Sjögren's aka konstruktoid's [hardening](https://github.com/konstruktoid/hardening) repository for 20.04 and beyond.
...
This also assumes you have come here from [BTRFS](Ubuntu Server 20.04 LVM Secure.md) starting points.
